...
### 2. Lessons from AI about values: evaluation needs values from outside the system and impetus for exploration
#### a. Maximum expected utility and ice cream [check Russell Norvig for earliest citation of MEU in this form]
#### b. Utility (one operationalization of values) is defined as part of the system's specification (subject to Godel's incompleteness as a set up to Nguyen on the inarcticulable)
#### b. Exploration
### 2. Society is an AI
