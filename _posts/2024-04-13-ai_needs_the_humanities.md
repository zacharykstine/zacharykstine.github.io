...
## Primary points
### 1. Hook and framing (which *could* be totally distinct from motivation, which could function as a nice conclusion capped off with a motivating call to action (but avoid being overly specific with actions to avoid coming across as preachy 
### 2. Lessons from AI about values, evaluation, and exploration
### 2. Society is an AI
...
#### b. Agent: humanity (which loses its distinction from the environment-problem)
